...
vpc = Boundary("Akamai Network")

corporatenetwork = Boundary("Corporate Network")

 # create an akamai asset in the akamai network boundary
akamai_asset = Server("Akamai Asset")
# place akaami asset in the akaami network boundary
akamai_asset.inBoundary = vpc
# create an intake service asset in the corporate network boundary
intake_service = Server("Intake Service")
# place intake service in the corporate network boundary
intake_service.inBoundary = corporatenetwork


user = Actor("SA Client")
...
# create data flow from user to akaami asset
user_to_akamai = Dataflow(user, akamai_asset, "Transfer data (*)")

# create data flow from akaami asset to intake service
akamai_to_intake = Dataflow(akamai_asset, intake_service, "Routes the data (*)")
